...
public class TreeNodeTests {
    ...
    public void testFromString() {
        TreeNode allRight = new TreeNode(1,
                null, new TreeNode(2,
                    null, new TreeNode(3,
                        null, new TreeNode(4,
                            null, new TreeNode(5)))));
        assertEquals(allRight, fromString("[1,null,2,null,3,null,4,null,5]"));
        ...
        assertEquals(example1, fromString("[10,5,-3,3,2,null,11,3,-2,null,1]"));
        ...
        TreeNode example2 = new TreeNode(1000000000,
                new TreeNode(1000000000,
                        ...
                        null),
                null);
        assertEquals(example2, fromString(
